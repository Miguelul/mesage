...
import 'datepickerwid.dart';

class DatePickerC extends StatefulWidget {
  ...
  @override
  State<StatefulWidget> createState() => _DatePickerCState();
}

class _DatePickerCState extends State<DatePickerC> {
...
//            print("Inside Inactive dates.");
          ...
          int index2 = 0;
          while (index2 < userdata.users[0].cronoDiaWork!.length) {
            isActi = dateFormat
                        .parse(userdata.users[0].cronoDiaWork![index2]!.fecha)
                        .weekday ==
                    index + 1 &&
                userdata.users[0].cronoDiaWork![index2]!.estado;
            if (isActi) break;
            index2++;
          }
          ...
          return DateWidgetC(
            ...
            visible: isActi,
            estadoColor: 100 == 100
                ?  const Color.fromARGB(255, 129, 50, 89)
                : kSeconColor,
            date: date,
...
class DatePickerController {
  _DatePickerCState? _datePickerState;

  // ignore: library_private_types_in_public_api
  void setDatePickerState(_DatePickerCState state) {
